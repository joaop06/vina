...
} from "@/components/admin/produtos/ProductImageGallery";
import {
  ProductVariantsEditor,
  type ProductVariantDraft,
} from "@/components/admin/produtos/ProductVariantsEditor";
import { CategoryMultiSelect } from "@/components/admin/produtos/CategoryMultiSelect";
import { buildMutationFormData } from "@/components/admin/http/uploadClient";
import {
  CATEGORY_MAX_DEPTH,
  buildCategoryTree,
  depthUnderParent,
