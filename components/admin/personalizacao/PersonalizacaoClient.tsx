...
import { LoadingButton } from "@/components/admin/shell/LoadingButton";
...
} from "@/components/admin/personalizacao/configDirty";
import {
  CONFIGURACOES_TABS,
  configTabHref,
  parseConfigTab,
  type ConfiguracoesTabId,
} from "@/components/admin/personalizacao/configTabs";
import {
  applySiteTheme,
...
const GeralPanel = dynamic(
  () =>
    import("@/components/admin/personalizacao/GeralPanel").then(
      (m) => m.GeralPanel,
    ),
  { ssr: false },
);
const ContatoPanel = dynamic(
  () =>
    import("@/components/admin/personalizacao/ContatoPanel").then(
      (m) => m.ContatoPanel,
    ),
  { ssr: false },
);
const WhatsAppPanel = dynamic(
  () =>
    import("@/components/admin/personalizacao/WhatsAppPanel").then(
      (m) => m.WhatsAppPanel,
    ),
  { ssr: false },
);
const VitrinePanel = dynamic(
  () =>
    import("@/components/admin/personalizacao/VitrinePanel").then(
      (m) => m.VitrinePanel,
    ),
  { ssr: false },
);
const NavegacaoPanel = dynamic(
  () =>
    import("@/components/admin/personalizacao/NavegacaoPanel").then(
      (m) => m.NavegacaoPanel,
    ),
  { ssr: false },
);
const TextosVitrinePanel = dynamic(
  () =>
    import("@/components/admin/personalizacao/TextosVitrinePanel").then(
...
const TemaAvancadoPanel = dynamic(
  () =>
    import("@/components/admin/personalizacao/TemaAvancadoPanel").then(
