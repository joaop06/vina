...
import { withPathLock } from "@/src/foundation/data/lock";
import { migrationIndicesRepair } from "@/src/foundation/indices/repair-all";
import {
  assertRegistryValid,
  DATA_MIGRATIONS,
...
import {
  ...
  stateFileChange,
} from "@/src/foundation/data/migrations/state";
import type {
  MigrationContext,
  MigrationRunSummary,
  MigrationTrigger,
} from "@/src/foundation/data/migrations/types";
import { validateMigrationFileChange } from "@/src/foundation/data/migrations/validate";
