...
import { DEFAULT_PRODUCT_WA_TEMPLATE_PARTS } from "./wa-product-template";
import { DEFAULT_CART_WA_TEMPLATE_PARTS } from "./wa-cart-template";
import { DEFAULT_COMPACT_CART_ITEM_PARTS } from "./wa-compact-template";
