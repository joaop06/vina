import type { CompactCartItemPartsInput } from "@/src/foundation/behaviors/whatsapp/wa-template-validation";
import { DEFAULT_CART_WA_COMPACT_ITEM } from "@/src/foundation/behaviors/whatsapp/wa-cart-template";
